...
print("For easier beginning every team starts with only the points acquired during the last year.")
...
while(True):
    ...
    # World Cup Qualification
        ...
        com = input("Which continental section do you want to see? (\'UEFA\', \'CAF\', \'AFC\', \'OFC\', \'CONCACAF\', \'CONMEBOL\', \'All\')")
        if com.lower() == "uefa":
            ...
            if day==1:
                ...
                com = input("How much info do you want? (group info: \'A\', ..., \'I\' or \'All\')")
                if com.lower() == "all":
                    print("UEFA Ranking:")
                    ranking.outMS(ranking.UEFA)
                elif com.lower() == "a":
    ...
    # dalsi den
        ...
        simulateDay()
    # zle zadany vstup
    else: print("That\'s not one of the options provided, please pick one of the options.")
