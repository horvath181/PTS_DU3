...
# funkcia vytvori vsetky kombinacie zapasov a vlozi ich do
# tabulky planovanych zapasov
...
def simDay():
    ...
    # inak vyberie 6 nahodnych zapasov a kona rovnako
    else:
        ...
        del(arrMatches[num6], arrMatches[num5], arrMatches[num4], arrMatches[num3],
			arrMatches[num2], arrMatches[num1])
...
def interCon(arr):
    ...
    # usporiadam tabulku
    arr = sorted(sorted(arr, key=operator.itemgetter(6)), key=operator.itemgetter(4,5),
		reverse=True)
